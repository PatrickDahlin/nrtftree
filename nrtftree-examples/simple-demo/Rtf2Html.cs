 ...
 * Class:		Rtf2Html
 * Description:	Traducci�n de documentos RTF a formato HTML.
 * Notes:       Contribuci�n de Francisco Javier Mar�n (http://www.xuletas.es/).
 ********************************************************************************/
...
namespace Net.Sgoliver.NRtfTree
{
    namespace Demo
    {
        ...
        public class Rtf2Html
        {
            ...
            /// <summary>
            /// StringBuilder empleado para escribir el c�digo HTML resultado
            /// </summary>
            private StringBuilder _builder;

            /// <summary>
            /// Formato de texto que se est� leyendo
            /// </summary>
            ...
            /// <summary>
            /// Obtiene o establece un valor que indica si se crear�n parrafos autom�ticamente
            /// </summary>
            ...
            /// <summary>
            /// Obtiene o establece un valor que indica si se ignorar�n los nombres de las fuentes.
            /// Establecer este valor como false generar� un archivo HTML sin propiedad CSS font-face
            /// </summary>
            ...
            /// <summary>
            /// Obtiene o establece un valor que indica si se reemplazar�n las entidades HTML
            /// del texto
            /// </summary>
            ...
            /// Los grupos de textos que usen esta fuente no incluir�n la propiedad font-face
            /// </summary>
            ...
            /// <summary>
            /// Obtiene o establece un valor que indica el tama�o de fuente que se ignorar�.
            /// Los grupos de texto que tengan ese tama�o no incluir�n la propiedad CSS font-size
            /// </summary>
            ...
            /// <summary>
            /// Obtiene o establece un valor que indica si se incrustar�n las im�genes en base64
            /// dentro del c�digo HTML  (true), o se guardar�n en un archivo (false)
            /// </summary>
            ...
            /// <summary>
            /// Obtiene o establece la ruta donde se guardar�n las im�genes contenidas en el
            /// c�digo RTF original. S�lo se usarar� si el valor de IncrustImages es false
            /// </summary>
            ...
            /// <summary>
            /// Obtiene o establece un valor que indica el formato en el que se guardar�n las im�genes
            /// incrustadas en el c�digo RTF convertido
            /// </summary>
            ...
            /// <summary>
            /// Convierte una cadena de c�digo RTF a formato HTML
            /// </summary>
            ...
            public string Convert(string rtf)
            {
                ...
                //Generar p�rrafos (cada 2 <br /><br /> se cambiar� por un <p>)
                if (AutoParagraph)
                {
            ...
            /// <summary>
            /// Funci�n encargada de procesar los nodos hijo de un nodo padre RTF un nodo del documento RTF
            ...
            /// <summary>
            /// Funci�n encargada de a�adir texto con el formato actual al c�digo html resultado
            /// </summary>
            ...
            /// <summary>
            /// Funci�n encargada de a�adir una imagen al c�digo HTML resultado
            /// </summary>
            ...
            private void WriteImage(ImageNode imageNode)
            {
                ...
                //Reducir imagen si el tama�o final es menor que el actual
                ...
                //A�adir imagen al resultado HTML
